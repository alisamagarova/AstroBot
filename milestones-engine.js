  ...
  const THEMES = [
    ...
    },
    {
      ...
      targets: [
        ...
        { planet: 'moon', lbl: { ru: 'Луна', en: 'Moon' }, w: 0.7 },
    ...
    },
    {
      ...
      targets: [
        { angle: 'mc', lbl: { ru: 'MC · X дом', en: 'MC · 10th' }, w: 1, needsHouses: true },
        { rulerOf: 10, lbl: { ru: 'управитель X', en: 'ruler of 10th' }, w: 0.85, needsHouses: true },
        { cusp: 6, lbl: { ru: 'куспид VI', en: '6th cusp' }, w: 0.8, needsHouses: true },
